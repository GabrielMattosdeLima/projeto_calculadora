 ...
 *
 * <p><strong>Técnicas de refatoração a serem demonstradas:</strong></p>
 * <ul>
 *     <li>Eliminação de variável estática (classe renomeada)</li>
 *     <li>Técnicas de refatoração de código (em breve)</li>
 ...
 * sem efeitos colaterais, permitindo maior testabilidade e facilitando testes unitários.</p>
 *
